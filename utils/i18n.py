...
TRANSLATIONS = {
    "zh": {
        "page_title": "能源调优引擎",
        "app_name": "能源调优引擎",
        "app_subtitle": "面向高能耗工厂、数据中心与储能场景的电费分析、削峰套利与经济性决策支持平台",
        "app_caption": "用于能源成本优化、储能评估与管理层决策支持的科技风演示工具。",
        "sidebar_title": "能源调优引擎",
        "sidebar_desc": "面向数据中心与数字基础设施的经济性分析决策助手",
        "language_toggle": "English",

        "chip_tou_tariff_analysis": "分时电价分析",
        "chip_power_charge_evaluation": "功率电费评估",
        "chip_storage_arbitrage": "储能套利仿真",
        "chip_financial_metrics": "经济性指标",

        "section_data_input": "负荷数据上传",
        "section_data_input_desc": "上传高能耗工厂、数据中心或数字基础设施各时段能耗负荷数据",
        "section_tariff": "电价配置",
        "section_tariff_desc": "选择分时电价模式并配置价格参数。",
        "section_power": "功率电费配置",
        "section_power_desc": "设置容量或需量计费方式。",
        "section_storage": "储能配置",
        "section_storage_desc": "选择是否启用储能，并定义系统参数。",
        ...
        "scenario_summary": "当前场景摘要",
        "executive_summary": "执行摘要",
        "detailed_insights": "详细解读",
        "before_after_overview": "优化前后对比",
        "detailed_result_table": "详细结果表",
        "detailed_result_table_hint": "以下表格用于工程复核与明细查看。",

        "label_tariff_mode": "电价模式",
        "label_power_mode": "功率计费",
        "label_storage_mode": "储能状态",
        ...
        "run_hint": "准备完成后运行场景分析",
        "run_button_new": "开始生成决策结果",

        "empty_title": "准备开始一次新的能源场景评估",
        "empty_body": "请先在左侧依次完成：1）上传负荷 CSV；2）配置电价模式；3）选择功率电费方式；4）按需启用储能系统；最后点击“开始生成决策结果”。如果暂时没有自己的数据，可以先下载模板文件进行试用。",

        "analysis_done": "本次场景分析已完成，以下结果可用于技术判断与管理决策。",
        "need_upload_first": "请上传负荷数据。",
        "need_tariff_upload_first": "请上传全年各时段电价表。",
        "need_storage_upload_first": "请上传储能系统参数数据表。",
        "simulation_failed": "分析失败（有数据未被正确输入）",

        "key_metrics": "分析指标",
        "kpi_desc": "优先展示可直接支持投资与部署决策的关键指标。",
        "oper_desc": "运行特征指标用于解释成本变化与峰值行为。",
        ...
        "average_annual_net_benefit": "引入储能系统平均年净收益",
        "payback_years": "回本周期",
        ...
        "saving_ratio": "节省比例",
        "energy_saving": "电量电费节省",
        "power_charge_saving": "功率电费节省",
        "peak_reduction": "峰值功率降低",
        "optimized_max_power": "优化后最大功率",
        ...
        "tariff_breakdown": "电价明细",
        "storage_result_preview": "储能结果预览",
        "tariff_result_preview": "电价结果预览",

        "factory_load_curve": "负荷时间序列",
        "avg_load_by_hour": "分时平均负荷",
        "load_with_price": "负荷 / 电价时间序列",
        "tariff_share_pie": "电价支出占比",
        "storage_soc_chart": "储能系统运行状态与 SOC 时间序列",
        ...
        "plot_avg_load": "平均负荷",
        "plot_price": "电价",
        "plot_charge_from_grid": "电网充电量 (kWh)",
        "plot_discharge_to_load": "向负荷放电量 (kWh)",
        "plot_soc": "SOC (kWh)",
        "plot_original_load": "原始负荷",
